...
import { RequestTeamModel, MyTicketModel } from '../../models/my-tickets.model';
...
@Component({
  selector: 'customerPortal-table-internal-my-tickets',
  templateUrl: './table-internal-my-tickets.component.html',
  styles: [
    `
      :host {
        display: block;
...
export class TableInternalMyTicketsComponent implements OnInit {
  constructor(
  ...
  @Select(MyTicketsState.myInternalTickets) public myTeams$: Observable<
  ...
  public client: Observable<string>;
  ...
  public openResolutionModal(resolution) {
  ...
  @Dispatch() public firePaginateMyTeams(pagination: PaginationConfigModel) {
    ...
    return new MY_TASKS_ACTIONS.PaginateMyInternalTickets(pagintationForm);
  }
}
